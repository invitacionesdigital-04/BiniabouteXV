...
function initializeCountdown() {
    const targetDate = new Date('2026-11-09T16:30:00').getTime();
...
function showDressCode() {
    showToast("Código de Vestimenta", "Formal 👗");
}

function sharePhotos() {
    window.open('https://photos.app.goo.gl/ctujJMiH12p4WRZdA', '_blank');
}

function confirmAttendance() {
    window.open('https://wa.me/18493992929?text=Confirmo+formalmente+mi+asistencia+a+los+XV.+Muchas+gracias+por+la+invitaci%C3%B3n.+Ser%C3%A1+un+placer+acompa%C3%B1arlos+en+esta+ocasi%C3%B3n+tan+especial.&utm_source=chatgpt.com', '_blank');
}
